# REVIEW — Tournamental docs pack readiness audit
...
docs/15-tournamental-brand-and-positioning.md      brand, NZ regulatory framing
...
- **Smart-contract audit** — full audit of TournamentalOracle / PoolFactory / Pool by Trail of Bits / OpenZeppelin / ConsenSys Diligence. 6–10 weeks, $30k–$80k. On-chain pools (doc 21) ship after audit.
...
1. **Repo name and visibility.** The folder is `SimulatedSports` but the brand is Tournamental. When to rename. Where to host (GitHub `vtorn` org? Codeberg? self-hosted?).
...
5. **Telegram bot username.** `@TournamentalBot`, `@TournamentalTournamentBot`, or other. Reserve early.
6. **tournamental.com landing.** A simple coming-soon page with email capture should go up well before the demo to start collecting interest.
