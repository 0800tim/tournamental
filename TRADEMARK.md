# Tournamental trademark and commercial structure

The Tournamental codebase is open source under [Apache License 2.0](LICENSE). The Tournamental brand, name, logo, and visual identity are not.

## What this means in practice

- **You can** fork this codebase, build on top of it, modify it, deploy it, and distribute your changes, all under the terms of Apache 2.0.
- **You cannot** use the name "Tournamental", the Tournamental logo, or any visually-confusing variation thereof on your fork or any derivative product. Apache 2.0 §6 explicitly excludes trademark rights from the licence grant: "This License does not grant permission to use the trade names, trademarks, service marks, or product names of the Licensor."
- **You will need to rebrand** any public deployment of a fork. Pick a new name, design new marks, and run your fork under that.

We're explicit about this not to be difficult, but because the alternative is confusing to users and unfair to contributors. If two services in the same niche both call themselves "Tournamental", neither benefits.
...
The canonical Tournamental service runs at:
...
For licensing questions, partnership enquiries, or anything that doesn't fit the above, email `legal@tournamental.com`.

For everything else — code, bugs, features, docs — open a GitHub issue.
