...
A lightweight markdown kanban for VTorn. Lives in-repo so the orchestrator and any agent can see and update it. No external tool. Survives across sessions because it's just files.
