...
Python service that converts StatsBomb open data for the **2022 FIFA World Cup Final, Argentina vs France** into the canonical Tournamental message stream (`@tournamental/spec` v0.1.1). Emits over WebSocket, writes NDJSON to disk, or pipes JSON-per-line to stdout.
