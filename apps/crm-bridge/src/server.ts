...
const corsOrigins = (
  ...
  'https://tournamental.com,https://play.tournamental.com,https://admin.tournamental.com,https://play.tournamental.com,https://crm.tournamental.com,http://localhost:3300'
)
  .split(',')
  .map((s) => s.trim())
  .filter(Boolean);
