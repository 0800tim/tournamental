/**
 * Swagger / OpenAPI registration for @vtorn/crm-bridge.
 *
 * Mounts:
 *   GET /docs            Swagger UI
  ...
  await app.register(swagger as any, {
    openapi: {
      ...
      info: {
        ...
        description:
          'Forwards user/prediction/syndicate events into GoHighLevel. Customer-360 aggregate endpoint.',
        version: '0.1.0',
        license: { name: 'Apache-2.0', url: 'https://www.apache.org/licenses/LICENSE-2.0' },
      },
      servers: [
        { url: 'http://localhost:3395', description: 'local dev' },
        { url: 'https://crm.tournamental.com', description: 'production' },
      ],
      tags: [
