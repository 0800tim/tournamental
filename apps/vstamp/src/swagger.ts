/**
 * Swagger / OpenAPI registration for @vtorn/vstamp.
 *
 * Mounts:
 *   GET /docs            Swagger UI
  ...
  await app.register(swagger as any, {
    openapi: {
      ...
      info: {
        title: 'VStamp API',
        description:
          'Tamper-evident prediction receipts. Merkle tree + Ed25519-signed roots.',
        version: '0.1.0',
        license: { name: 'Apache-2.0', url: 'https://www.apache.org/licenses/LICENSE-2.0' },
      },
      servers: [
        { url: 'http://localhost:3380', description: 'local dev' },
        { url: 'https://vstamp.tournamental.com', description: 'production' },
      ],
      tags: [
