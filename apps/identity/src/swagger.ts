/**
 * Swagger / OpenAPI registration for @vtorn/identity.
 *
 * Mounts:
 *   GET /docs            Swagger UI
  ...
  await app.register(swagger as any, {
    openapi: {
      ...
      info: {
        title: 'Identity API',
        description:
          'Multi-provider OAuth link adapters and per-user Humanness Score.',
        version: '0.1.0',
        license: { name: 'Apache-2.0', url: 'https://www.apache.org/licenses/LICENSE-2.0' },
      },
      servers: [
        { url: 'http://localhost:3392', description: 'local dev' },
        { url: 'https://identity.tournamental.com', description: 'production' },
      ],
      tags: [
