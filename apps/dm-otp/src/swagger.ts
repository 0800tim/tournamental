/**
 * Swagger / OpenAPI registration for @vtorn/dm-otp.
 *
 * Mounts:
 *   GET /docs            Swagger UI
  ...
  await app.register(swagger as any, {
    openapi: {
      ...
      info: {
        title: 'DM-OTP API',
        description:
          'User-initiated DM-OTP login across 17 messaging platforms.',
        version: '0.1.0',
        license: { name: 'Apache-2.0', url: 'https://www.apache.org/licenses/LICENSE-2.0' },
      },
      servers: [
        { url: 'http://localhost:3331', description: 'local dev' },
        { url: 'https://dm-otp.tournamental.com', description: 'production' },
      ],
      tags: [
