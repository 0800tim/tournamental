/**
 * Swagger / OpenAPI registration for @vtorn/drips-bridge.
 *
 * Mounts:
 *   GET /docs            Swagger UI
...
export async function registerSwagger(app: FastifyInstance): Promise<void> {
  ...
  await app.register(swagger as any, {
    openapi: {
      openapi: '3.0.0',
      info: {
        title: 'Drips Bridge API',
        description:
          'Contributor registry + revenue-distribution lifecycle bridge to the Drips Network.',
        version: '0.1.0',
        license: { name: 'Apache-2.0', url: 'https://www.apache.org/licenses/LICENSE-2.0' },
      },
      servers: [
        { url: 'http://localhost:3399', description: 'local dev' },
        { url: 'https://drips.tournamental.com', description: 'production' },
      ],
      tags: [
