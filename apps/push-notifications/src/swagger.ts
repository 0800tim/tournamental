/**
 * Swagger / OpenAPI registration for @vtorn/push-notifications.
 *
 * Mounts:
 *   GET /docs            Swagger UI
  ...
  await app.register(swagger as any, {
    openapi: {
      ...
      info: {
        ...
        description:
          'Web Push + Telegram + SMS fan-out + kickoff scheduler.',
        version: '0.1.0',
        license: { name: 'Apache-2.0', url: 'https://www.apache.org/licenses/LICENSE-2.0' },
      },
      servers: [
        { url: 'http://localhost:3398', description: 'local dev' },
        { url: 'https://push.tournamental.com', description: 'production' },
      ],
      tags: [
