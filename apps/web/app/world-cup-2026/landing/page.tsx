...
export const metadata: Metadata = {
  ...
  description:
    "VTourn is the prediction game for the 2026 FIFA World Cup. Free to play. Lock in your bracket now — earlier picks score bigger. 48 teams, 104 matches, one open-source bracket.",
  openGraph: {
