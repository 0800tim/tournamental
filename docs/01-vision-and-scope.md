...
- [`15-vtorn-brand-and-positioning.md`](15-vtorn-brand-and-positioning.md) — VTorn brand identity, taglines, NZ-aware regulatory framing, free-to-play / affiliate-link separation, monetisation paths.
...
- [`19-open-source-and-contributor-revenue.md`](19-open-source-and-contributor-revenue.md) — Apache 2.0 license, VTorn Holdings + Foundation structure, Drips Network contributor revshare, fork policy, comparable projects.
...
- [`21-onchain-sweepstakes-oracle.md`](21-onchain-sweepstakes-oracle.md) — user-deployed Pool contracts on Polygon / Base, VTornOracle (4-of-7 multisig) for verified match results, geo-restricted UI, trustless settlement.
